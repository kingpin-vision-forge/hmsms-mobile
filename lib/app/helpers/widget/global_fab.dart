...
import 'package:student_management/app/helpers/widget/time_table_dialog.dart';
              ...
              onPressed: isLoading.value
                  ...
                  : () async {
                      if (titleController.text.isEmpty ||
                        ...
                        botToastError('Please fill in all fields');
                        return;
                      }
                      ...
                      try {
                        ...
                        if (res.isSuccessful && res.body['success'] == true) {
                          Get.back();
                          botToastSuccess('Announcement sent successfully');
                        } else {
                          botToastError(
                            res.body['message'] ??
                        ...
                        botToastError('Failed to send announcement');
                      } finally {
